...
RUN curl -L -o embedding_model.tar.gz https://storage.googleapis.com/ai_model_cafeboo/embedding_model.tar.gz \
 ...
 && curl -L -o ELECTRA.quant.onnx https://storage.googleapis.com/ai_model_cafeboo/moderation_model/ELECTRA.quant.onnx \
 && curl -L -o roberta.quant.onnx https://storage.googleapis.com/ai_model_cafeboo/moderation_model/roberta.quant.onnx
